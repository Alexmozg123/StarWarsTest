...
class StarWarsAdapter : ListAdapter<UIModel, ViewHolder>(StarshipComparator()) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when (holder) {
            is PeopleViewHolder -> holder.bind(item as UIModel.PeopleModel)
            is StarshipViewHolder -> holder.bind(item as UIModel.StarshipModel)
        }
    }
    ...
    class StarshipViewHolder(view: View) : ViewHolder(view) {
        ...
        fun bind(item: UIModel.StarshipModel) {
    ...
    class PeopleViewHolder(view: View) : ViewHolder(view) {
        private var nameStarship = view.findViewById<TextView>(R.id.tvNameOfShip)
        private var gender = view.findViewById<TextView>(R.id.tvModel)
        private var countStarships = view.findViewById<TextView>(R.id.tvManufacturer)

        fun bind(item: UIModel.PeopleModel) {
            nameStarship.text = item.people.name
